...
the result is a script to set all your fans and aio to a colour and brightness. if you want per-fan control or scheduling, everything you need is already in there, you can extend it yourself. the hard part was the reverse engineering (which no one seems to have documented). adapting it is the easy part 
